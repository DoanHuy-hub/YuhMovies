<?php
	...
	/************** Load hot movies end ***************/
	/************** Load free movies begin ***************/
	$sql="SELECT * FROM movies WHERE price ORDER BY idmovie DESC LIMIT 24";
	$resultFree=mysqli_query($conn,$sql);
	/************** Load free movies end ***************/
		...
		<div class="container">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#free" role="tab" id="free-tab" data-toggle="tab" aria-controls="free" aria-expanded="false">Phim Miễn Phí</a></li>
				</ul>
				<div id="myTabContent" class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade" id="free" aria-labelledby="free-tab">
						<?php while ($rowFree=mysqli_fetch_array($resultFree)) {
							 $idmovie = 	$rowFree["idmovie"];
						?>
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="moviedetail.php?idmovie=<?=$idmovie?>" title="<?php echo $rowFree['viename']; ?>" class="hvr-shutter-out-horizontal"><img src="<?php echo $rowFree["image"] ?>" title="<?php echo $rowFree['viename']; ?>" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="moviedetail.php?idmovie=<?=$idmovie?>"title="<?php echo $rowFree['viename']; ?>"><?php echo $rowFree['viename']; ?></a></h6>
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>
										<?php
