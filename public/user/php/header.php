			...
			<div class="row">
				<div class="col-md-4 text-center">
					<div class="w3layouts_logo">
						<a href="index.php"><h1>Yuh<span>Movies</span></h1></a>
					</div>
				</div>
				<div class="col-md-4 text-center">
					<div class="w3_search">
				...
				{ ?>
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>Chào <?php echo $_SESSION['namefilm']?></h4> <b class="caret"></b></a>
                	...
                	<ul class="nav pull-right">
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>Chào <?php echo $_SESSION['namefilm'].' ';?><img src="images/vip.gif"></h4> <b class="caret"></b></a>
                        <ul class="dropdown-menu pull-center">
                            <li class="loggedin"><a href="moviecabinet.php?iduser=<?=$iduserfilm?>"><img src="images/cabinet.png">Tủ Phim <?php echo "($rowCabinet)"; ?></a></li>
                            <li class="loggedin"><a href="profile.php"><img src="images/profile.png">Hồ Sơ</a></li>
